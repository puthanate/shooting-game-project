...
public class shooting_5_separate extends JFrame{
		...
		public void mousePressed(final MouseEvent me) {
			...
			for(int i = 0; i < 5; i++ )
			{
				if(missile_flag[i] == 0)
                {
                   ...
                   my_missile_y[i] = 400;
				   missile_flag[i] = 1;
				   break; // so it doesn't fire at 1 time
                }
			}    
		}
